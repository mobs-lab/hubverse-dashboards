...
const SeasonOverviewAllLocationBoxPlot: React.FC<SeasonOverviewLocationAggregatedScoreChartAltProps> = ({ type }) => {
  ...
  const updateTooltip = useCallback(
    (
      ...
      return () => {
        ...
        const values = [data.lowerWhisker, data.lowerBox, data.median, data.upperBox, data.upperWhisker];
